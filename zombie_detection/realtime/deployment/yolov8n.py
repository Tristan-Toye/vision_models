"""YOLOv8n — weights under ``submission_models/yolov8n/``.

Best mixed test precision: **0.9813**.
"""
...
class YOLOv8nDeploymentPipeline(ZombieDetectorPipeline):
    mixed_test_precision: float = 0.9812981000481
    _local_dir: Path = submission_models_dir() / "yolov8n"
    ...
    def describe(self) -> str:
        return (
            f"yolov8n mixed_test_precision={self.mixed_test_precision:.4f} "
