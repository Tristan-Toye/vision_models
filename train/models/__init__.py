...
from train.models.heatmap_cnn import HeatmapCNN
from train.models.resnet_backbone import ResNetDetector
from train.models.yolo_wrapper import YOLODetector
from train.models.fasterrcnn_wrapper import FasterRCNNDetector
from train.models.detr_wrapper import RTDETRDetector
...
MODEL_REGISTRY = {
    ...
    "hog_svm": "train.models.sliding_window:HOGSVMDetector",
    "template_match": "train.models.sliding_window:TemplateMatchDetector",
}
